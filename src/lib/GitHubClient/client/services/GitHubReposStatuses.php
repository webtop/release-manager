...
class GitHubReposStatuses extends GitHubService
{
     ...
     *            be linked from the GitHub UI to allow users to easily see the
     *            ‘source’ of the Status.
     *            For example, if your Continuous Integration system is posting
     *            build status, you would want to provide the deep link for the
     ...
     *
     * @param $ref string
     *            (Required) - Ref to list the statuses from. It can be a SHA, a
     ...
     *
     * @param $ref string
     *            (Required) - Ref to fetch the status for. It can be a SHA, a
     *            branch name, or a tag name.
     * @return GitHubStatus
     */
