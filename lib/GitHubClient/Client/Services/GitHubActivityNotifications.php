...
class GitHubActivityNotifications extends GitHubService {
     ...
     *            (Optional) `true` to show only notifications in which the user
     *            is
     *            directly participating or mentioned.
     * @param $since time
     *            (Optional) filters out any notifications updated before the
     *            given
     *            time. The time should be passed in as UTC in the ISO 8601
     *            format:
     ...
     * Mark as read
     *
     * @param $last_read_at Time
     *            (Optional) Describes the last point that notifications were
     *            checked. Anything
     *            updated since this time will not be updated. Default: Now.
     *            Expected in ISO
