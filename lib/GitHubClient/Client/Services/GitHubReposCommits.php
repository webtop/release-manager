...
class GitHubReposCommits extends GitHubService {
     ...
     * @param $path string
     *            (Optional) - Only commits containing this file path
     *            will be returned.
     * @param $author string
     *            (Optional) - GitHub login, name, or email by which to filter
     *            by
     *            commit author
     * @param $since ISO
     *            8601 Date (Optional) - Only commits after this date will be
     *            returned
     * @param $until ISO
     *            8601 Date (Optional) - Only commits before this date will be
     *            returned
