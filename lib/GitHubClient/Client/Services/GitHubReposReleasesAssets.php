...
class GitHubReposReleasesAssets extends GitHubService {
     ...
     *            (Required) The content type of the asset. This should be set
     *            in the Header. Example: “application/zip”. For a list of
     *            acceptable types, refer this list of common media types.
     * @param $name string
     *            (Required) The file name of the asset. This should be set in
