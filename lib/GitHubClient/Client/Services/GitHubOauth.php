...
class GitHubOauth extends GitHubService {
     ...
     *
     * @param $scopes array
     *            (Optional) - Replaces the authorization scopes with these.
     * @param $note string
     *            (Optional) - A note to remind you what the OAuth token is for.
     * @param $note_url string
     *            (Optional) - A URL to remind you what app the OAuth token is
     *            for.
     * @param $client_id string
     *            (Optional) - The 20 character OAuth app client key for which
     *            to create the token.
     * @param $client_secret string
     *            (Optional) - The 40 character OAuth app client secret for
     *            which to create the token.
     * @param $fingerprint string
     *            (Optional) - A unique string to distinguish an authorization
     ...
     * @param $scopes array
     *            (Optional) - Replaces the authorization scopes with these.
     * @param $add_scopes array
     *            (Optional) - A list of scopes to add to this authorization.
     * @param $remove_scopes array
     *            (Optional) - A list of scopes to remove from this
     *            authorization.
     * @param $note string
     *            (Optional) - A note to remind you what the OAuth token is for.
     * @param $note_url string
