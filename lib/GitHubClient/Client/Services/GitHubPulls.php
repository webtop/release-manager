...
use Library\GitHubClient\Client\Services\GitHubPullsComments;
use Library\GitHubClient\Client\Objects\GitHubPull;
use Library\GitHubClient\Client\Objects\GitHubFullPull;
...
class GitHubPulls extends GitHubService {
     ...
     *
     * @param $state string
     *            (Optional) - `open`, `closed` or `all` to filter by state.
     *            Default
     *            is `open`.
     * @param $head string
     *            (Optional) - Filter pulls by head user and branch name in the
     *            format
     *            of: `user:ref-name`. Example: `github:new-script-format`.
     * @param $base string
     *            (Optional) - Filter pulls by base branch name. Example:
     *            `gh-pages`.
     * @param $sort string
     *            (Optional) - What to sort results by. Can be either `created`,
     *            `updated`, popularity (comment count) or long-running (age,
     *            filtering by pulls updated
     *            in the last month). Default: `created`
     * @param $direction string
     *            (Optional) - The direction of the sort. Can be either `asc` or
     *            `desc`. Default: `desc` when sort is created or sort is not
     ...
     *
     * @param $state string
     *            - State of this Pull Request. Valid values are either `open`
     *            or `closed`.
     * @param $title string
     ...
     * @param string $base
     *            (Required) The name of the branch you want your changes pulled
     *            into.
