...
class GitHubRepos extends GitHubService {
     ...
     *
     * @param $type string
     *            (Optional) - Can be one of all, owner, public, private,
     *            member. Default: all
     * @param $sort string
     *            (Optional) - Can be one of created, updated, pushed,
     *            full_name. Default: full_name
     * @param $direction string
     *            (Optional) - Can be one of asc or desc. Default: when using
     ...
     *
     * @param $since string
     *            (Optional) - The integer ID of the last Repository that
     *            you�ve seen.
     *            
     * @return array<GitHubSimpleRepo>
     */
     ...
     *
     * @param $owner String
     *            (Optional) - The name of the organization, if organization not
     *            specified the repo will be created for the authenticated user.
     * @param $repo String
     *            (Required) - The name of the repository.
     * @param $private boolean
     *            (Optional) - `true` makes the repository private, and
     *            `false` makes it public.
     * @param $has_issues boolean
     *            (Optional) - `true` to enable issues for this repository,
     *            `false` to disable them. Default is `true`.
     * @param $has_wiki boolean
     *            (Optional) - `true` to enable the wiki for this
     *            repository, `false` to disable it. Default is `true`.
     * @param $has_downloads boolean
     *            (Optional) - `true` to enable downloads for this
     ...
     * @param $team_id int
     *            (Optional) - The id of the team that will be granted access to
     *            this repository. This is only valid when creating a repository
     *            in an organization.
     * @param $auto_init Boolean
     *            (Optional) - Pass true to create an initial commit with empty
     *            README. Default: false.
     * @param $gitignore_template String
     *            (Optional) - Desired language or platform .gitignore template
     *            to apply. Use the name of the template without the extension.
     *            For example, �Haskell�.
     * @param $license_template String
     *            (Optional) - Desired LICENSE template to apply. Use the name
     *            of the template without the extension. For example, �mit�
     *            or �mozilla�.
