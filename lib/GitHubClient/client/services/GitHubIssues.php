...
class GitHubIssues extends GitHubService
{
     ...
     *            true, for all my issues, false, for all issues or organization
     *            name all issues
     * @param
     *            filter string Indicates which sorts of issues to return. Can
     *            be one of:
     ...
     *            Default: assigned
     * @param
     *            state string Indicates the state of the issues to return. Can
     *            be either open, closed, or all. Default: open
     * @param
     *            labels string A list of comma separated label names. Example:
     *            bug,ui,@high
     * @param
     *            sort string What to sort results by. Can be either created,
     *            updated, comments. Default: created
     * @param
     *            direction string The direction of the sort. Can be either asc
     *            or desc. Default: desc
     * @param
     *            since string Only issues updated at or after this time are
     ...
     *            (Optional) - Login for the user that this issue should be
     *            assigned to.
     * @param $creator string
     *            (Optional) - Login for the user that created this issue.
     * @param $mentioned string
     *            (Optional) - Login for a user mentioned in this issue.
     * @param
     *            labels string A list of comma separated label names. Example:
     *            bug,ui,@high
     * @param
     ...
     * @param $body string
     *            (Optional) - The contents of the issue.
     * @param $assignees array
     *            (Optional) of **strings** - Login(s) for the user(s) that this
     *            issue
     *            should be assigned to. Supplying a string here still works for
     *            backwards compatibility but
     *            will be removed in the future.
     * @param $milestone number
     *            (Optional) - Milestone to associate this issue with.
     * @param $labels array
     *            (Optional) of strings - Labels to associate with this issue.
     *            Pass one or more Labels to _replace_ the set of Labels on this
     *            Issue.
     ...
     *            will be removed in the future.
     * @param $state string
     *            (Optional) - State of the issue: `open` or `closed`.
     * @param $milestone number
     *            (Optional) - Milestone to associate this issue with.
     * @param $labels array
     *            (Optional) of **strings** - Labels to associate with this
     *            issue. Pass one or more Labels to _replace_ the set of Labels
     *            on this
     *            Issue. Send an empty array (`[]`) to clear all Labels from the
     *            Issue.
     * @return GitHubIssue
     */
